...
public:
    ControllerModifierSource(EctoControllerSource &source, const std::function<double(double)> &positionFunction, const std::function<double(double)> &velocityFunction);
