...
EctoMagic::EctoMagic(EctoController &controller, const MotionProfileConfig &motionProfileConfig) : baseController(controller), motionProfile(motionProfileConfig) {
