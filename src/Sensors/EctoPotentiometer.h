...
class EctoPotentiometer : public frc::PIDSource, public EctoControllerSource {
public:
	explicit EctoPotentiometer(int port, double potentiometerRange, double lowerVoltageLimit, double upperVoltageLimit, double voltageOffset);
